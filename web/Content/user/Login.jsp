...
<body>
	...
	<form class="login" id="loginForm" action="/CMS/user/login.action" method="post" >
		<h2>
			用户登录
		</h2>
		<div class="user">
			<label class="label" for="userName">用户名</label>
			<input class="text" type="text" id="userName" name="user.userName" />
		</div>
		<div class="password">
			<label class="label" for="password">密       码</label>
			<input class="text" type="password" id="password" name="user.password" />
		</div>
		<div class="autoLogin">
		...
		<div class="b">
			...
			<a class="button1" href="/CMS/user/Register" >注册</a>
		</div>	
	</form>
	<%
